"""bench1.png == pathology npz 원본 이미지. ki67_hybrid_bench1 (2).json의 cell 1~4
polyline 결과를 각각 매칭된 실제 GT 인스턴스와 겹쳐서 시각화.
"""
import json
...
JSON_PATH = Path('/mnt/Disk1/sylee/benchmark/gt_comparison/ki67_hybrid_bench1 (2).json')
...
OUT_DIR = Path('/mnt/Disk1/sylee/benchmark/gt_comparison/overlays_negative_new')
OUT_DIR.mkdir(exist_ok=True)

CELL_TO_GT_ID = {1: 20, 2: 55, 3: 38, 4: 36}
PAD = 15
SCALE = 4
